# Binance USDⓈ-M Exchange Specification
#
# Auto-generated by: mix ccxt.extract binanceusdm
# CCXT version: 4.5.34
...
%{
  ...
  endpoint_extraction_stats: %{
    ...
    "failures" => [
      %{
        "error" => "binanceusdm triggerPrice parameter is not allowed for BTC/USDT:USDT limit orders",
      ...
      %{
        "error" => "binanceusdm triggerPrice parameter is not allowed for BTC/USDT:USDT market orders",
      ...
      %{
        "error" => "binanceusdm editContractOrder() does not support spot orders",
        "method" => "editOrders"
      },
      %{
        "error" => "binanceusdm fetchLedgerEntry() can only be used for type option",
        "method" => "fetchLedgerEntry"
      },
      %{
        "error" => "binanceusdm fetchMySettlementHistory() supports option markets only",
        "method" => "fetchMySettlementHistory"
      },
      %{
        "error" => "binanceusdm fetchOpenOrder() does not support spot markets",
        "method" => "fetchOpenOrder"
      },
      %{
        "error" => "binanceusdm fetchPosition() supports option markets only",
        "method" => "fetchPosition"
      },
      %{
        "error" => "binanceusdm fetchPositionsRisk() requires an array argument for symbols",
        "method" => "fetchPositionsRisk"
      },
      %{
        "error" => "binanceusdm fetchSettlementHistory() supports option markets only",
  ...
  endpoints: [
    ...
    %{
      ...
      default_params: %{
        ...
        "clientAlgoId" => "x-cvBPrNm9cae276dea2504cd289b3dd",
        "newOrderRespType" => "RESULT",
        "symbol" => "BTCUSDT",
  ...
  error_code_details: %{
    ...
    -5021 => %{
      description: "Due to the order could not be filled immediately, the FOK order has been rejected.",
      type: :invalid_order
    },
    -5022 => %{
      description: "Due to the order could not be executed as maker, the Post Only order will be rejected.",
      type: :invalid_order
    },
    -5028 => %{
  ...
  extended_metadata: %{
    ...
    logo_url: "https://github.com/user-attachments/assets/871cbea7-eebb-4b28-b260-c1c91df0487a",
