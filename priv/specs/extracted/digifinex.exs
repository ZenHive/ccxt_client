...
%{
  ...
  endpoints: [
    ...
    %{
      ...
      path: "/margin/assets",
      response_transformer: {:extract_path_unwrap, ["list"]},
      source: :intercepted
    },
    %{
      api_section: "private/spot",
    ...
    %{
      ...
      response_transformer: {:extract_path, ["data", "finance"]},
      source: :intercepted
    },
    %{
      api_section: "public/swap",
    ...
    %{
      ...
      path: "/kline",
      response_transformer: {:extract_path, ["data", "candles"]},
      source: :intercepted
    },
    %{
      api_section: "private/spot",
    ...
    %{
      ...
      params: [],
      path: "/ping",
      response_transformer: {:extract_path, ["code"]},
      source: :intercepted
    },
    %{
      api_section: "public/spot",
