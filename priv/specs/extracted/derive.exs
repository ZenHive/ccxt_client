...
%{
  ...
  endpoints: [
    ...
    %{
      ...
      response_transformer: {:extract_path_unwrap, ["result", "funding_rate_history"]},
      source: :intercepted
    },
    %{
      api_section: "public",
      ...
      path: "/get_funding_rate_history",
      response_transformer: {:extract_path, ["result", "funding_rate_history"]},
      source: :intercepted
    },
    %{
      api_section: "public",
      ...
      response_transformer: {:extract_path, ["result", "instruments"]},
      source: :intercepted
    },
    %{
      api_section: "public",
  ...
  symbol_formats: %{
    option: %{
      ...
      settle: "USDC",
      settle_id: "USDC",
      symbol: "SOL/USDC:USDC-260327-95-P",
      taker: 0.0003
    },
    precision_mode: 4,
    sample_limits: %{
