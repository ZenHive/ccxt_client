# FMFW.io Exchange Specification
#
# Auto-generated by: mix ccxt.extract fmfwio
# CCXT version: 4.5.34
...
%{
  ...
  endpoint_extraction_stats: %{
    ...
    "failures" => [
      %{
        "error" => "fmfwio fetchPosition() not support this market type",
        "method" => "fetchPosition"
      },
      %{
        "error" => "fmfwio setLeverage() requires a margin_balance parameter that will transfer margin to the specified trading pair",
        "method" => "setLeverage"
      }
    ]
  },
  ...
  extended_metadata: %{
    fees_url: "https://fmfw.io/fees-and-limits",
    limits: %{
      "amount" => %{},
      "cost" => %{},
      "leverage" => %{},
    ...
    logo_url: "https://user-images.githubusercontent.com/1294454/159177712-b685b40c-5269-4cea-ac83-f7894c49525d.jpg",
    referral_url: "https://fmfw.io/referral/da948b21d6c92d69"
  },
  extracted_metadata: %{
    ccxt_version: "4.5.34"
  },
