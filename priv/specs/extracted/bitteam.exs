...
%{
  ...
  endpoints: [
    ...
    %{
      ...
      response_transformer: {:extract_path, ["result", "currencies"]},
      source: :intercepted
    },
    %{
      api_section: "private",
      ...
      response_transformer: {:extract_path, ["result", "transactions"]},
      source: :intercepted
    },
    %{
      api_section: "public",
    ...
    %{
      ...
      response_transformer: {:extract_path, ["result", "pairs"]},
      source: :intercepted
    },
    %{
      api_section: "private",
    ...
    %{
      ...
      response_transformer: {:extract_path_unwrap, ["result", "pair"]},
      source: :intercepted
    },
    %{
      api_section: "public",
