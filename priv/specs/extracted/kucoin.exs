...
%{
  ...
  endpoints: [
    ...
    %{
      ...
      path: "/orders/{orderId}",
      response_transformer: {:extract_path, ["data", "cancelledOrderIds"]},
      source: :intercepted
    },
    %{
      api_section: "private",
    ...
    %{
      ...
      response_transformer: {:extract_path, ["data", "items"]},
      source: :intercepted
    },
    %{
      api_section: "private",
    ...
    %{
      ...
      path: "/withdrawals/quotas",
      response_transformer: {:extract_path, ["data", "withdrawMinFee"]},
      source: :intercepted
    },
    %{
      api_section: "private",
  ...
  ws: %{
    channel_templates: %{
      ...
      watch_bids_asks: %{
        channel_name: "/spotMarket/level1:",
        market_id_format: :native,
        params: [],
        pattern: :type_topic,
        separator: ":"
