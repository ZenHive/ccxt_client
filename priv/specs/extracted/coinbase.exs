...
%{
  ...
  endpoints: [
    ...
    %{
      ...
      response_transformer: {:extract_path, ["trade"]},
      source: :intercepted
    },
    %{
      api_section: "v3/private",
    ...
    %{
      ...
      cost: 1,
      default_params: %{
        "client_order_id" => "ccxt-7a4a71fc-c6c0-4a97-9b29-c93902f97c41",
        "order_configuration" => %{
          "limit_limit_gtc" => %{
            "base_size" => "0.001",
            "limit_price" => "50000",
    ...
    %{
      ...
      cost: 1,
      default_params: %{
        "client_order_id" => "ccxt-6f4286b8-c66b-4ca2-aeb4-c30867ce2945",
        "order_configuration" => %{
          "limit_limit_gtc" => %{
            "base_size" => "0.001",
            "limit_price" => "50000",
    ...
    %{
      ...
      cost: 1,
      default_params: %{
        "client_order_id" => "ccxt-4fd8193a-8189-4986-8cf1-8cbda28ccdd2",
        "order_configuration" => %{
          "limit_limit_gtc" => %{
            "base_size" => "0.001",
            "limit_price" => "50000",
    ...
    %{
      ...
      cost: 1,
      default_params: %{
        "client_order_id" => "ccxt-119ecdd1-8cc1-4b4b-b7ec-8899be44b64f",
        "order_configuration" => %{
          "market_market_ioc" => %{
            "quote_size" => "0.001"
          }
    ...
    %{
      ...
      cost: 1,
      default_params: %{
        "client_order_id" => "ccxt-f9582104-ae57-4d4f-94ce-29fc9a83670d",
        "order_configuration" => %{
          "market_market_ioc" => %{
            "quote_size" => "100"
          }
    ...
    %{
      ...
      cost: 1,
      default_params: %{
        "client_order_id" => "ccxt-923ecb6a-f177-48ee-9e80-868cecdb2a67",
        "order_configuration" => %{
          "market_market_ioc" => %{
            "quote_size" => "0.001"
          }
    ...
    %{
      ...
      cost: 1,
      default_params: %{
        "client_order_id" => "ccxt-4171116d-0d39-4e58-a756-90d02dd019ea",
        "order_configuration" => %{
          "market_market_ioc" => %{
            "base_size" => "0.001"
          }
    ...
    %{
      ...
      cost: 1,
      default_params: %{
        "client_order_id" => "ccxt-a90039dd-a745-45ea-a09c-a743a45fb8cf",
        "order_configuration" => %{
          "limit_limit_gtc" => %{
            "base_size" => "0.001",
            "limit_price" => "50000",
    ...
    %{
      ...
      cost: 1,
      default_params: %{
        "client_order_id" => "ccxt-bed22f6c-20dd-4d56-b4d7-b22bdb542d0a",
        "order_configuration" => %{
          "limit_limit_gtc" => %{
            "base_size" => "0.001",
            "limit_price" => "50000",
    ...
    %{
      ...
      cost: 1,
      default_params: %{
        "client_order_id" => "ccxt-479b5ad1-c757-4fac-8127-a01a45df2c39",
        "order_configuration" => %{
    ...
    %{
      ...
      cost: 1,
      default_params: %{
        "client_order_id" => "ccxt-4b5b89ba-10ca-46df-b7a2-e934d0069ee3",
        "order_configuration" => %{
          "stop_limit_stop_limit_gtc" => %{
            "base_size" => "0.001",
            "limit_price" => "50000",
    ...
    %{
      ...
      response_transformer: {:extract_path, ["pricebooks"]},
      source: :intercepted
    },
    %{
      api_section: "v3/private",
    ...
    %{
      ...
      response_transformer: {:extract_path, ["payment_method"]},
      source: :intercepted
    },
    %{
      api_section: "v3/private",
      ...
      response_transformer: {:extract_path, ["payment_methods"]},
      source: :intercepted
    },
    %{
      api_section: "v3/private",
    ...
    %{
      ...
      path: "/brokerage/accounts",
      response_transformer: {:extract_path, ["pagination", "next_starting_after"]},
      source: :intercepted
    },
    %{
    ...
    %{
      ...
      response_transformer: {:extract_path_unwrap, ["order"]},
      source: :intercepted
    },
    %{
      api_section: "v3/public",
      ...
      response_transformer: {:extract_path_unwrap, ["pricebook"]},
      source: :intercepted
    },
    %{
      api_section: "v3/private",
    ...
    %{
      ...
      response_transformer: {:extract_path_unwrap, ["position"]},
      source: :intercepted
    },
    %{
      api_section: "v3/private",
    ...
    %{
      ...
      path: "/brokerage/market/products",
      response_transformer: {:extract_path, ["products"]},
      source: :intercepted
    },
    %{
      api_section: "v2/public",
    ...
    %{
      ...
      response_transformer: {:extract_path, ["fee_tier"]},
      source: :intercepted
    },
    %{
      api_section: "v3/private",
