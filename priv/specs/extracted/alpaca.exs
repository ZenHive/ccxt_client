...
%{
  ...
  endpoints: [
    ...
    %{
      ...
      cost: 1.0,
      default_params: %{
        "client_order_id" => "ccxt_815cc8db237e4622a974a3e246a7b29e",
        "time_in_force" => "gtc",
        "type" => "limit"
      },
      market_type: :spot,
    ...
    %{
      ...
      cost: 1.0,
      default_params: %{
        "client_order_id" => "ccxt_77ac1d08262147c497bce0d0424a1e6a",
        "side" => "buy",
        "time_in_force" => "gtc",
        "type" => "market"
      },
    ...
    %{
      ...
      cost: 1.0,
      default_params: %{
        "client_order_id" => "ccxt_b10fe7b9214f43798e4b8cc5b40d0658",
        "side" => "buy",
        "time_in_force" => "gtc",
        "type" => "market"
      },
    ...
    %{
      ...
      cost: 1.0,
      default_params: %{
        "client_order_id" => "ccxt_f403785baee2408ba87407c65088585a",
        "time_in_force" => "gtc",
        "type" => "market"
      },
      market_type: :spot,
    ...
    %{
      ...
      cost: 1.0,
      default_params: %{
        "client_order_id" => "ccxt_08dd098c66d54ec5a8dd45941d412d3d",
        "time_in_force" => "gtc",
        "type" => "market"
      },
      market_type: :spot,
    ...
    %{
      ...
      cost: 1.0,
      default_params: %{
        "client_order_id" => "ccxt_aada1d90744341b6ba260f57213a0659",
        "time_in_force" => "gtc"
      },
      market_type: :spot,
      method: :post,
    ...
    %{
      ...
      cost: 1.0,
      default_params: %{
        "client_order_id" => "ccxt_8df377dc9fe04e079eea9c76359de984",
        "symbol" => "BTCUSDT",
        "time_in_force" => "gtc",
    ...
    %{
      ...
      cost: 1.0,
      default_params: %{
        "client_order_id" => "ccxt_e4c6c96472fd405391718894f1bb8583",
        "symbol" => "BTCUSDT",
        "time_in_force" => "gtc",
        "triggerDirection" => "below",
        "type" => "stop_limit"
    ...
    %{
      ...
      cost: 1.0,
      default_params: %{
        "client_order_id" => "ccxt_bf6e1246751e4fee967c05ea9a025ff4",
        "time_in_force" => "gtc"
      },
      market_type: :spot,
      method: :patch,
