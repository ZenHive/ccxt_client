# WOOFI PRO Exchange Specification
#
# Auto-generated by: mix ccxt.extract woofipro
# CCXT version: 4.5.34
...
%{
  ...
  endpoint_extraction_stats: %{
    ...
    "failures" => [
      ...
      %{
        "error" => "woofipro withdraw() only support USDC",
        "method" => "withdraw"
      }
    ]
  },
  ...
  extended_metadata: %{
    ...
    logo_url: "https://github.com/user-attachments/assets/9ba21b8a-a9c7-4770-b7f1-ce3bcbde68c1",
    referral_discount: 0.05,
    referral_url: "https://dex.woo.org/en/trade?ref=CCXT"
  },
  extracted_metadata: %{
    ccxt_version: "4.5.34"
  },
