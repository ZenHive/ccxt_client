...
%{
  ...
  endpoints: [
    ...
    %{
      ...
      path: "/info",
      response_transformer: {:extract_path, ["data", "info"]},
      source: :intercepted
    },
    %{
      api_section: "v1/private",
    ...
    %{
      ...
      params: [],
      path: "/info",
      response_transformer: {:extract_path, ["data", "accountGroup"]},
      source: :intercepted
    },
    %{
      api_section: "v1/private",
    ...
    %{
      ...
      response_transformer: {:extract_path_unwrap, ["data", "address"]},
      source: :intercepted
    },
    %{
      api_section: "v2/public",
    ...
    %{
      ...
      path: "/wallet/transactions",
      response_transformer: {:extract_path, ["data", "data"]},
      source: :intercepted
    },
    %{
      api_section: "v1/private",
    ...
    %{
      ...
      response_transformer: {:extract_path, ["data", "contracts"]},
      source: :intercepted
    },
    %{
    ...
    %{
      ...
      path: "/depth",
      response_transformer: {:extract_path_unwrap, ["data", "data"]},
      source: :intercepted
    },
    %{
      api_section: "v1/private",
    ...
    %{
      ...
      params: [],
      path: "/exchange-info",
      response_transformer: {:extract_path, ["data", "requestReceiveAt"]},
      source: :intercepted
    },
    %{
      api_section: "v1/public",
    ...
    %{
      ...
      params: [],
      path: "/info",
      response_transformer: {:extract_path, ["data", "fees"]},
      source: :intercepted
    },
    %{
      api_section: "v1/private",
