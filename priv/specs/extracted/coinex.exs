...
%{
  ...
  endpoints: [
    ...
    %{
      ...
      cost: 1.0,
      default_params: %{
        "client_id" => "x-167673045-fcc13a9cd426963f",
        "market_type" => "SPOT",
        "type" => "limit"
      },
      market_type: :spot,
    ...
    %{
      ...
      cost: 1.0,
      default_params: %{
        "client_id" => "x-167673045-9baee0d95465bbc5",
        "market_type" => "SPOT",
        "side" => "buy",
        "type" => "market"
      },
    ...
    %{
      ...
      cost: 1.0,
      default_params: %{
        "client_id" => "x-167673045-eee6ca4bf4e89ee2",
        "market_type" => "SPOT"
      },
      market_type: :spot,
      method: :post,
    ...
    %{
      ...
      default_params: %{
        ...
        "orders" => [
          %{
            "amount" => "0.001",
            "client_id" => "x-167673045-7049f21ef483be77",
            "market" => "BTCUSDT",
            "market_type" => "FUTURES",
            "price" => "50000",
            "side" => "buy",
    ...
    %{
      ...
      cost: 1.0,
      default_params: %{
        "client_id" => "x-167673045-5d37fc03e48e952f",
        "market" => "BTCUSDT",
        "market_type" => "FUTURES"
      },
      market_type: :swap,
    ...
    %{
      ...
      cost: 1.0,
      default_params: %{
        "client_id" => "x-167673045-0d78654ac4c781d9",
        "market" => "BTCUSDT",
        "market_type" => "FUTURES",
    ...
    %{
      ...
      cost: 1.0,
      default_params: %{
        "client_id" => "x-167673045-22c7f813b4f49152",
        "market" => "BTCUSDT",
        "market_type" => "FUTURES",
        "triggerDirection" => "below",
    ...
    %{
      ...
      cost: 1.0,
      default_params: %{
        "client_id" => "x-167673045-1255d9d1c4af9069",
        "market" => "BTCUSDT",
        "market_type" => "FUTURES",
    ...
    %{
      ...
      cost: 1.0,
      default_params: %{
        "client_id" => "x-167673045-b069bfd4949a9cf0",
        "market" => "BTCUSDT",
        "market_type" => "FUTURES",
        "triggerDirection" => "below",
        "trigger_price_type" => "latest_price"
