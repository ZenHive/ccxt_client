defmodule CCXT.Risk do
  ...
  ## Example
      ...
      CCXT.Risk.concentration(positions)
  ...
  ## Example
      ...
      CCXT.Risk.max_position_size(100_000, max_position_pct: 0.25)
      # => 25_000
  ...
  ## Example
      ...
      CCXT.Risk.check_limits(positions, limits)
  ...
  ## Example
      ...
      CCXT.Risk.beta(portfolio, benchmark)
  ...
  ## Example
      ...
      CCXT.Risk.sharpe_ratio(returns)
      # => 1.2
  ...
  ## Example
      ...
      CCXT.Risk.sortino_ratio(returns)
      # => 1.5
  ...
  ## Example
      ...
      CCXT.Risk.calmar_ratio(returns)
      # => 2.5
