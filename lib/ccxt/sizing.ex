defmodule CCXT.Sizing do
  ...
  ## Example
      ...
      CCXT.Sizing.fixed_fractional(100_000, 0.01, 500)
      # => 2.0  (2 units where each unit has $500 max loss)

      # Kelly criterion
      CCXT.Sizing.kelly(0.55, 1.5)
  ...
  ## Example
      ...
      CCXT.Sizing.kelly(0.55, 1.5, 0.25)
  ...
  ## Example
      ...
      CCXT.Sizing.volatility_scaled(100_000, 0.01, 50, 30)
  ...
  ## Example
      ...
      CCXT.Sizing.anti_martingale(1.0, 3, 0.25)
      # => 1.75 contracts

      # Base 1 contract, 2 consecutive losses
      CCXT.Sizing.anti_martingale(1.0, -2, 0.25)
      # => 0.5 contracts
