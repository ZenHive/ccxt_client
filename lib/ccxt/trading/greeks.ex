defmodule CCXT.Trading.Greeks do
  @moduledoc """
  ...
  ## Example
      ...
      CCXT.Trading.Greeks.position_greeks(positions)
  ...
  ## Example
      ...
      CCXT.Trading.Greeks.dollar_delta(5.0, 50_000, 1)
      # => 250_000.0
  ...
  ## Example
      ...
      CCXT.Trading.Greeks.dollar_gamma(0.5, 50_000)
  ...
  ## Example
      ...
      CCXT.Trading.Greeks.delta_neutral?(0.05, 0.1)
      # => true
  ...
  ## Example
      ...
      CCXT.Trading.Greeks.hedge_ratio(5.0)
      # => -5.0 (sell 5 futures)
  ...
  ## Example
      ...
      CCXT.Trading.Greeks.from_chain(chain, positions)
  ...
  ## Example
      ...
      CCXT.Trading.Greeks.daily_theta(positions)
  ...
  ## Example
      ...
      CCXT.Trading.Greeks.vega_exposure(positions)
  ...
  ## Example
      ...
      CCXT.Trading.Greeks.gamma_pnl(0.1, 50_000, 2.0)
      # => 500.0
