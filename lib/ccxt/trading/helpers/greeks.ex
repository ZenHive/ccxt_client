defmodule CCXT.Trading.Helpers.Greeks do
  @moduledoc """
  ...
  ## Example
      ...
      CCXT.Trading.Helpers.Greeks.days_to_expiry(expiry_ms)
      # => 5.5 (days from now)

      # Determine moneyness
      CCXT.Trading.Helpers.Greeks.moneyness(50_000.0, 48_000.0, :call)
      # => :itm (in the money)
  ...
  ## Examples
      ...
      CCXT.Trading.Helpers.Greeks.days_to_expiry(future_ms)
      # => ~1.0

      # Already expired (returns negative)
      past_ms = System.system_time(:millisecond) - 86_400_000
      CCXT.Trading.Helpers.Greeks.days_to_expiry(past_ms)
      # => ~-1.0
  ...
  ## Example
      ...
      CCXT.Trading.Helpers.Greeks.days_to_expiry_from_datetime(expiry)
  ...
  ## Examples
      ...
      iex> CCXT.Trading.Helpers.Greeks.moneyness(50_000.0, 48_000.0, :call)
      :itm

      iex> CCXT.Trading.Helpers.Greeks.moneyness(50_000.0, 52_000.0, :call)
      :otm

      iex> CCXT.Trading.Helpers.Greeks.moneyness(50_000.0, 48_000.0, :put)
      :otm

      iex> CCXT.Trading.Helpers.Greeks.moneyness(50_000.0, 52_000.0, :put)
      :itm

      iex> CCXT.Trading.Helpers.Greeks.moneyness(50_000.0, 50_000.0, :call)
      :atm
