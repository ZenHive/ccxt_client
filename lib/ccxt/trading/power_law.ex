defmodule CCXT.Trading.PowerLaw do
  @moduledoc """
  ...
  ## Example
      ...
      CCXT.Trading.PowerLaw.fair_value()
      # => 85000.0

      # Calculate z-score for current price
      CCXT.Trading.PowerLaw.z_score(95000.0)
  ...
  ## Example
      ...
      CCXT.Trading.PowerLaw.fair_value(~D[2025-01-01])
      # => 75000.0

      CCXT.Trading.PowerLaw.fair_value(6000)
  ...
  ## Example
      ...
      CCXT.Trading.PowerLaw.z_score(50000.0)
      # => -0.82
  ...
  ## Example
      ...
      CCXT.Trading.PowerLaw.resistance()
      # => 150000.0
  ...
  ## Example
      ...
      CCXT.Trading.PowerLaw.days_since_genesis()
      # => 5845

      CCXT.Trading.PowerLaw.days_since_genesis(~D[2025-01-01])
      # => 5842
  ...
  ## Example
      ...
      CCXT.Trading.PowerLaw.classify(95000.0)
      # => :fair

      CCXT.Trading.PowerLaw.classify(200000.0)
      # => :overvalued
  ...
  ## Example
      ...
      CCXT.Trading.PowerLaw.genesis_date()
      # => ~D[2009-01-03]
