defmodule CCXT.Trading.Volatility do
  @moduledoc """
  ...
  ## Example
      ...
      CCXT.Trading.Volatility.realized(prices)
      # => 0.023  (2.3% daily volatility)

      CCXT.Trading.Volatility.realized(prices, annualize: true)
  ...
  ## Example
      ...
      CCXT.Trading.Volatility.parkinson(candles)
      # => 0.034
  ...
  ## Example
      ...
      CCXT.Trading.Volatility.iv_percentile(0.65, [0.40, 0.55, 0.60, 0.70, 0.80])
  ...
  ## Example
      ...
      CCXT.Trading.Volatility.iv_rank(0.65, [0.40, 0.55, 0.60, 0.70, 0.80])
  ...
  ## Example
      ...
      CCXT.Trading.Volatility.iv_vs_rv(0.65, 0.50)
      # => 1.3 (IV is 30% higher than RV)

      CCXT.Trading.Volatility.iv_vs_rv(0.65, 0.50, :premium)
      # => 0.15

      CCXT.Trading.Volatility.iv_vs_rv(0.65, 0.50, :premium_pct)
      # => 30.0
  ...
  ## Example
      ...
      CCXT.Trading.Volatility.cone(prices, [5, 10, 20, 30])
  ...
  ## Example
      ...
      CCXT.Trading.Volatility.elevated?(0.45, 0.30)
      # => true (0.45 > 0.30 * 1.5)
  ...
  ## Example
      ...
      CCXT.Trading.Volatility.rolling(prices, 5)
