defmodule CCXT.Trading.Basis do
  @moduledoc """
  ...
  ## Example
      ...
      CCXT.Trading.Basis.spot_perp(50_000, 50_100)
      # => %{absolute: 100.0, percent: 0.2, direction: :contango}

      CCXT.Trading.Basis.annualized(50_000, 50_100, 30)
  ...
  ## Example
      ...
      CCXT.Trading.Basis.spot_perp(50_000, 49_900)
  ...
  ## Example
      ...
      CCXT.Trading.Basis.futures_curve(50_000, futures)
      # => [
  ...
  ## Example
      ...
      CCXT.Trading.Basis.implied_funding(50_000, 50_050)
  ...
  ## Example
      ...
      CCXT.Trading.Basis.compare(exchanges)
      # => [
  ...
  ## Example
      ...
      CCXT.Trading.Basis.arbitrage_opportunity?(50_000, 50_100, 0.1)
