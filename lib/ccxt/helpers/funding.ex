defmodule CCXT.Helpers.Funding do
  @moduledoc """
  ...
  ## Example
      ...
      CCXT.Helpers.Funding.next_funding()
      # => 2.5 (hours until next funding)

      CCXT.Helpers.Funding.next_funding_at()
  ...
  ## Example
      ...
      CCXT.Helpers.Funding.next_funding_from(past_time)
  ...
  ## Example
      ...
      past_time = ~U[2025-01-15 07:30:00Z]
      CCXT.Helpers.Funding.next_funding_at_from(past_time)
