defmodule CCXT.Helpers.Risk do
  @moduledoc """
  ...
  ## Example
      ...
      CCXT.Helpers.Risk.margin_headroom(position)
      # => 0.2 (20% headroom)

      CCXT.Helpers.Risk.liquidation_distance(position)
  ...
  ## Examples
      ...
      iex> CCXT.Helpers.Risk.margin_headroom(position)
      0.2
  ...
  ## Examples
      ...
      iex> position = %CCXT.Types.Position{mark_price: 50_000.0, liquidation_price: 40_000.0}
      iex> CCXT.Helpers.Risk.liquidation_distance(position)
      10_000.0
