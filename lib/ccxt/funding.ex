defmodule CCXT.Funding do
  ...
  ## Example
      ...
      CCXT.Funding.average(rates)
      # => 0.000125

      CCXT.Funding.annualize(0.0001)
      # => 0.1095  (10.95% APR)
  ...
  ## Example
      ...
      CCXT.Funding.annualize(0.0001, 4)
  ...
  ## Example
      ...
      CCXT.Funding.detect_spikes(rates, threshold: 2.0)
  ...
  ## Example
      ...
      CCXT.Funding.favorable?(%FundingRate{funding_rate: 0.0001}, :short)
      # => true

      CCXT.Funding.favorable?(%FundingRate{funding_rate: 0.0001}, :long)
      # => false
