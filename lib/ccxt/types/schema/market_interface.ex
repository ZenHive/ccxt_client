defmodule CCXT.Types.Schema.MarketInterface do
  ...
  - `id` - Exchange-specific market identifier. String.t() | nil
  - `numeric_id` - Numeric market identifier (some exchanges). number() | nil (optional)
  - `uppercase_id` - Uppercase version of the market ID. String.t() | nil (optional)
  - `lowercase_id` - Lowercase version of the market ID. String.t() | nil (optional)
  - `symbol` - Unified symbol (e.g. "BTC/USDT", "BTC/USDT:USDT"). String.t()
  - `base` - Base currency code (e.g. "BTC"). String.t()
  - `quote` - Quote currency code (e.g. "USDT"). String.t()
  - `base_id` - Exchange-specific base currency identifier. String.t() | nil
  - `quote_id` - Exchange-specific quote currency identifier. String.t() | nil
  - `active` - Whether the market is currently tradeable. boolean() | nil
  - `type` - Market type: "spot", "swap", "future", or "option". String.t()
  - `sub_type` - Market subtype: "linear" or "inverse". String.t() | nil (optional)
  - `spot` - Whether this is a spot market. boolean()
  - `margin` - Whether margin trading is available. boolean()
  - `swap` - Whether this is a perpetual swap. boolean()
  - `future` - Whether this is a dated futures contract. boolean()
  - `option` - Whether this is an options contract. boolean()
  - `contract` - Whether this is a contract market (swap, future, or option). boolean()
  - `settle` - Settlement currency code (e.g. "USDT"). String.t() | nil
  - `settle_id` - Exchange-specific settlement currency identifier. String.t() | nil
  - `contract_size` - Size of one contract in base currency units. number() | nil
  - `linear` - Whether the contract is linear (quote-settled). boolean() | nil
  - `inverse` - Whether the contract is inverse (base-settled). boolean() | nil
  - `quanto` - Whether the contract is quanto. boolean() (optional)
  - `expiry` - Contract expiry timestamp in milliseconds. integer() | nil
  - `expiry_datetime` - ISO 8601 expiry datetime string. String.t() | nil
  - `strike` - Option strike price. number() | nil
  - `option_type` - Option type: "call" or "put". String.t() | nil
  - `taker` - Taker fee rate as a decimal. number() | nil (optional)
  - `maker` - Maker fee rate as a decimal. number() | nil (optional)
  - `percentage` - Whether fee rates are percentages. boolean() | nil (optional)
  - `tier_based` - Whether fees use a tiered structure. boolean() | nil (optional)
  - `fee_side` - Which side of the trade the fee is charged on. String.t() | nil (optional)
