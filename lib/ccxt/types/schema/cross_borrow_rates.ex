defmodule CCXT.Types.Schema.CrossBorrowRates do
  @moduledoc """
  Auto-generated map type alias for `CCXT.Types.CrossBorrowRates`.
  ...
  @fields []
  @type_spec_str """
  %{optional(String.t()) => CCXT.Types.CrossBorrowRate.t()}
  """
