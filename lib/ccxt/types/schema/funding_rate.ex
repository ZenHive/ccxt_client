defmodule CCXT.Types.Schema.FundingRate do
  ...
  - `symbol` - Trading pair identifier (e.g. "BTC/USDT:USDT"). String.t()
  - `raw` - Raw exchange response data. any()
  - `timestamp` - Unix timestamp in milliseconds. number() (optional)
  - `funding_rate` - Current funding rate as a decimal (e.g. 0.0001 = 0.01%). number() (optional)
  - `datetime` - ISO 8601 datetime string. String.t() (optional)
  - `mark_price` - Current mark price. number() (optional)
  - `index_price` - Current index/spot price. number() (optional)
  - `interest_rate` - Interest rate component of funding. number() (optional)
  - `estimated_settle_price` - Estimated settlement price. number() (optional)
  - `funding_timestamp` - Timestamp when current funding rate applies. number() (optional)
  - `funding_datetime` - ISO 8601 datetime for current funding period. String.t() (optional)
  - `next_funding_timestamp` - Timestamp of the next funding period. number() (optional)
  - `next_funding_datetime` - ISO 8601 datetime for next funding period. String.t() (optional)
  - `next_funding_rate` - Predicted next funding rate. number() (optional)
  - `previous_funding_timestamp` - Timestamp of previous funding period. number() (optional)
  - `previous_funding_datetime` - ISO 8601 datetime for previous funding period. String.t() (optional)
  - `previous_funding_rate` - Previous funding rate. number() (optional)
  - `interval` - Funding interval (e.g. "8h"). String.t() (optional)
