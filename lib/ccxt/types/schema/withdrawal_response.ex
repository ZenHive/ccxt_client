defmodule CCXT.Types.Schema.WithdrawalResponse do
  @moduledoc """
  Auto-generated schema for `CCXT.Types.WithdrawalResponse`.
  ...
  This module is used by `CCXT.Types.WithdrawalResponse`:

      defmodule CCXT.Types.WithdrawalResponse do
        use CCXT.Types.Schema.WithdrawalResponse
      end
  ...
  @type_spec_str """
  %__MODULE__{raw: any(), id: String.t()}
  """
