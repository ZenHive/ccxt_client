defmodule CCXT.Options do
  ...
  `CCXT.Options.Deribit.parse_option/1`.
  ...
  ## Example
      ...
      CCXT.Options.oi_by_strike(chain)
      # => %{84000.0 => 150.0}

      CCXT.Options.put_call_ratio(chain)
      # => 0.5
  ...
  ## Example
      ...
      CCXT.Options.oi_by_expiry(chain)
  ...
  ## Example
      ...
      CCXT.Options.time_to_expiry(~D[2026-01-31])
  ...
  ## Example
      ...
      CCXT.Options.filter_by_dte(chain, 7)
  ...
  @doc """
  Deprecated: Use `max_pain/1` instead.

  The spot price parameter was unused and has been removed.
  This wrapper exists for backward compatibility.
  """
  @deprecated "Use max_pain/1 instead - spot parameter was unused"
  @spec max_pain(option_chain(), number()) :: {:ok, strike()} | {:error, :empty_chain}
  def max_pain(chain, _spot), do: max_pain(chain)
  ...
  ## Example
      ...
      CCXT.Options.session_phase(~D[2026-01-31])
      # => :early
  ...
  ## Example
      ...
      CCXT.Options.largest_positions(chain, 5)
  ...
  ## Example
      ...
      CCXT.Options.strike_distance(90000.0, 85000.0)
  ...
  ## Example
      ...
      CCXT.Options.in_play?(84000.0, 85000.0, 5.0)
  ...
  ## Example
      ...
      CCXT.Options.gex_by_strike(chain, 85000.0)
  ...
  ## Example
      ...
      CCXT.Options.gamma_flip(chain, 85000.0)
      # => {:ok, 84500.0}
  ...
  ## Example
      ...
      CCXT.Options.pin_magnets(chain, 85000.0)
  ...
  ## Example
      ...
      CCXT.Options.hot_zone(chain, 85000.0)
