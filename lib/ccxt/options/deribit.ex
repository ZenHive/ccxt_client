defmodule CCXT.Options.Deribit do
  @moduledoc """
  ...
  ## Example
      ...
      CCXT.Options.Deribit.parse_option("BTC-31JAN26-84000-C")
      # => {:ok, %{underlying: "BTC", expiry: ~D[2026-01-31], strike: 84000.0, type: :call}}

      CCXT.Options.Deribit.parse_option("ETH-28MAR25-2500-P")
  ...
  ## Example
      ...
      iex> CCXT.Options.Deribit.parse_option("BTC-31JAN26-84000-C")
      {:ok, %{underlying: "BTC", expiry: ~D[2026-01-31], strike: 84000.0, type: :call}}

      iex> CCXT.Options.Deribit.parse_option("invalid")
  ...
  ## Example
      ...
      iex> CCXT.Options.Deribit.strike("BTC-31JAN26-84000-C")
      {:ok, 84000.0}
  ...
  ## Example
      ...
      iex> CCXT.Options.Deribit.expiry("BTC-31JAN26-84000-C")
      {:ok, ~D[2026-01-31]}
  ...
  ## Example
      ...
      iex> CCXT.Options.Deribit.option_type("BTC-31JAN26-84000-C")
      {:ok, :call}
  ...
  ## Example
      ...
      iex> CCXT.Options.Deribit.underlying("BTC-31JAN26-84000-C")
      {:ok, "BTC"}
  ...
  ## Example
      ...
      iex> CCXT.Options.Deribit.valid_option?("BTC-31JAN26-84000-C")
      true

      iex> CCXT.Options.Deribit.valid_option?("BTC/USDT")
      false
